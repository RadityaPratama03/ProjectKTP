 ...
 */
package dataktp.ktpku.Dummy;

import dataktp.ktpku.Dummy.exceptions.NonexistentEntityException;
import dataktp.ktpku.Dummy.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("dataktp_ktp-ku_jar_0.0.1-SNAPSHOTPU");
